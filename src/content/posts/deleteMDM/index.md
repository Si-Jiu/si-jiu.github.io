...
1. 打開安裝程式，點擊下一步  
![1](./iTunesInstall1.png)
2. 建議取消 _將iTunes用作音頻文件的默認播放器_ 其他默認，點擊安裝  
![1](./iTunesInstall2.png)
3. 等待安裝，安裝完成後點擊結束  
![1](./iTunesInstall3.png)
...
![1](./iBackupBotInstall1.png)
2. 點擊下一步  
![1](./iBackupBotInstall2.png)
3. 點擊我接受  
![1](./iBackupBotInstall3.png)
4. 建議默認，點擊下一步  
![1](./iBackupBotInstall4.png)
5. 點擊安裝  
![1](./iBackupBotInstall5.png)
6. 保持默認，點擊完成  
![1](./iBackupBotInstall6.png)
